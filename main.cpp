...
public:
	...
	bool verticalDoors{}; // Set to true if door is up / down, not left / right#include <iostream>
#include <conio.h>
#include <vector>
#include <string>
...
// Medium, editing map and player placing floor things
class StationaryEnemy {
public:
	int SpinSpeed{}; // Speed enemy spins
	int range{}; // Range in chars enemy can see
};
